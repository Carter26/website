...
const STEPS_BUSINESS = [
  ...
  { title: 'Subscribe to Activate Your Listings', desc: 'For just $20/month, activate your business subscription via PayPal or Cash App. Submit your payment confirmation and our team will activate your account within 24 hours.', tip: 'Founding members who join in the first 90 days receive a permanent badge and priority placement.' },
