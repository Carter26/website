...
const FAQS = [
  ...
  { q: 'How do I become a Founding Member?', a: 'Any business that joins within the first 90 days of our platform launch automatically qualifies for Founding Member status, which includes a special badge, priority placement, and homepage recognition.' },
